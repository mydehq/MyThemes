...
async function loadVersions() {
    ...
    try {
        ...
        if (!versions || versions.length === 0) {
            versionsList.innerHTML = '<tr><td colspan="3" class="text-center text-secondary py-4">No versions available</td></tr>';
            return;
        }
        ...
        const versionsList = document.getElementById('versions-list');
        versionsList.innerHTML = '<tr><td colspan="3"><div class="text-center text-danger py-4">Version data unavailable.<br>Please contact the repository maintainer.</div></td></tr>';
    }
}
